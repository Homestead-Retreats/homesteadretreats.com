    ...
    <div>
      <div className="offsite-rec-images">
        <div className="div-one">
          ...
          <img src="http://www.homesteadretreats.com/Offsite_Recreation_files/shapeimage_2.jpg" alt="people gathering on basketball court" className="people"/>
        </div>
        <div className="div-two">
          <img src="http://www.homesteadretreats.com/Offsite_Recreation_files/shapeimage_3.jpg" alt="people eating around a table" className="table"/>
        </div>
        <div className="div-three">
          <img src="http://www.homesteadretreats.com/Offsite_Recreation_files/flower.jpg" alt="flowers in metal bin" className="flower"/>
        </div>
      </div>
